...
Error.stackTraceLimit = 0; // "No stacktrace"" is usually best for lib testing.
...
// get from karma.config.js, then prefix with '/base/' (default is 'dist-test/')
var builtPaths = (__karma__.config.builtPaths || ['dist-test/'])
